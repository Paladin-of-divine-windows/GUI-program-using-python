...
def create_window():
    sg.theme('black')
    layout = [
        [sg.Push(), sg.Image(dir_path +'/cross.png', pad = 0, enable_events=True, key = '-CLOSE-')],
        [sg.VPush()],
    ...
    return sg.Window('StopWach', layout, size = (300, 300), no_titlebar=True, element_justification='center')
